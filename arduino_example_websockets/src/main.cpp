...
void startWiFi() { // Start a Wi-Fi access point, and try to connect to some given access points. Then wait for either an AP or STA connection
  WiFi.softAP(SECRET_AP_NAME, SECRET_AP_PASS);             // Start the access point
  Serial.print("Access Point \"");
  Serial.print(SECRET_AP_NAME);
  Serial.println("\" started\r\n");

  wifiMulti.addAP(SECRET_WIFIMULTI2_NAME, SECRET_WIFIMULTI2_PASS);
  wifiMulti.addAP(SECRET_WIFIMULTI1_NAME, SECRET_WIFIMULTI1_PASS);
...
void startOTA() { // Start the OTA service
  ArduinoOTA.setHostname(SECRET_OTA_NAME);
